...
public class BatchConfigToFetchDataFromDB {
...
/*
	...
	public Step stepForDBToCSV() {
		return stepBuilderFactory.get("StepForDBToCSV").<Student, Student>chunk(10)
	...
	@Bean
	public Job fetchRecordsFromDBToCSVJob() {
		return jobBuilderFactory.get("Export-Student-Data-From-DB").incrementer(new RunIdIncrementer())
				.start(stepForDBToCSV()).build();
	}
	*/
